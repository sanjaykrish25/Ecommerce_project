...
import { MsalBroadcastConfiguration, MsalService } from '@azure/msal-angular';
...
export class GraphService {
  ...
  constructor(private http: HttpClient, private sanitizer: DomSanitizer, private msalService:MsalService) { }
